...
export const navigation: readonly NavigationItem[] = [
  ...
  group("Fee Configuration", "/masters/fee-heads", "settings", [item("Fee Heads","/masters/fee-heads","fees"),item("Payment Modes","/masters/payment-modes","finance")]),
  group("Student Management", "/students", "graduation-cap", [item("Student Master","/students","users"),item("Academic Assignments","/students/academic-assignments","graduation-cap"),item("Academic Year Rollover","/students/rollover","rollover"),item("Enrollment Breaks","/students/enrollment-breaks","calendar")]),
  ...
  group("Fees", "/fees", "fees", [item("Overview","/fees","dashboard"),item("Fee Structures","/fees/structures","academics"),item("Pending Fees","/fees/student-fees","users"),item("Collect Payment","/fees/collect","finance"),item("Payments","/fees/payments","finance"),item("Reports & Ledger","/fees/reports","reports"),item("WhatsApp Outbox","/fees/messages","communication"),item("Settings","/fees/settings","settings")]),
  group("Administration", "/administration/users", "settings", [item("User Management","/administration/users","users",DASHBOARD_ROLES)]),
  item("Dashboard","/student/dashboard","dashboard",[ROLE.STUDENT]),item("My Question Papers","/practice-work/my-work","homework",[ROLE.STUDENT]),item("My Schedule","/student/schedule","calendar",[ROLE.STUDENT]),item("My Attendance","/student/attendance","attendance",[ROLE.STUDENT]),item("My Results","/student/results","marks",[ROLE.STUDENT]),item("My Fees","/student/fees","fees",[ROLE.STUDENT]),item("Notifications","/student/notifications","communication",[ROLE.STUDENT]),item("Dashboard","/parent/dashboard","dashboard",[ROLE.PARENT]),item("Attendance","/parent/attendance","attendance",[ROLE.PARENT]),item("Schedule","/parent/schedule","calendar",[ROLE.PARENT]),item("Fees","/parent/fees","fees",[ROLE.PARENT]),item("Results","/parent/results","marks",[ROLE.PARENT]),item("Continuation","/parent/continuation","rollover",[ROLE.PARENT]),item("Logout","/logout","logout",allPortalRoles),
];
