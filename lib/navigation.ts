...
export type NavigationIconName = "dashboard"|"calendar"|"school"|"graduation-cap"|"users"|"user-round"|"book-open"|"academics"|"attendance"|"planner"|"homework"|"exams"|"marks"|"report-card"|"finance"|"fees"|"communication"|"announcements"|"reports"|"settings"|"logout";
...
export const navigation: readonly NavigationItem[] = [
  ...
  group("Student Management", "/students", "graduation-cap", [item("Student Master","/students","users"),item("Academic Assignments","/students/academic-assignments","graduation-cap")]),
