...
export const navigation: readonly NavigationItem[] = [
  ...
  group("Learning Planner", "/learning-planner", "planner", [item("Calendar","/learning-planner/calendar","calendar"),item("Recurring Schedules","/learning-planner/schedules","planner"),item("Exam Results","/learning-planner/exam-results","marks"),item("Holidays","/learning-planner/holidays","calendar"),item("Planner Notifications","/learning-planner/notifications","communication"),item("History","/learning-planner/history","reports")]),
  ...
  group("Communication", "/communication/notifications", "communication", [item("Notifications","/communication/notifications","communication")]),
