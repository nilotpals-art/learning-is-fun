...
export const navigation: readonly NavigationItem[] = [
  ...
  group("Fees", "/fees", "fees", [item("Overview","/fees","dashboard"),item("Fee Structures","/fees/structures","academics"),item("Pending Fees","/fees/student-fees","users"),item("Collect Payment","/fees/collect","finance"),item("Payments","/fees/payments","finance"),item("Reports & Ledger","/fees/reports","reports"),item("WhatsApp Outbox","/fees/messages","communication"),item("Fee Heads","/masters/fee-heads","fees"),item("Payment Modes","/masters/payment-modes","finance"),item("Settings","/fees/settings","settings")]),
