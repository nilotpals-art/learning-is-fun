...
export const navigation: readonly NavigationItem[] = [
  ...
  group("Student Management", "/students", "graduation-cap", [item("Student Master","/students","users"),item("Parent Enrollment Links","/students/enrollment-links","communication"),item("Facebook Enquiries","/students/facebook-enquiries","communication"),item("Academic Assignments","/students/academic-assignments","graduation-cap"),item("Academic Year Rollover","/students/rollover","rollover"),item("Enrollment Breaks","/students/enrollment-breaks","calendar")]),
