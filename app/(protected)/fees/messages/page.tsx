...
import { deleteQueuedFeeMessagesFormAction } from "@/features/fees/actions/delete-queued-messages";
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-2xl border bg-card p-6 shadow-sm">
        ...
        <form action={deleteQueuedFeeMessagesFormAction} className="mt-4 grid gap-3 md:grid-cols-[1fr_auto] md:items-end">
