    ...
    <div className="space-y-6">
      <Card>
        <CardContent className="grid gap-4 p-4 sm:grid-cols-2 xl:grid-cols-5">
          <label className="text-sm font-medium">From Date<Input type="date" value={fromDate} onChange={(event) => setFromDate(event.target.value)} /></label>
          <label className="text-sm font-medium">To Date<Input type="date" value={toDate} onChange={(event) => setToDate(event.target.value)} /></label>
