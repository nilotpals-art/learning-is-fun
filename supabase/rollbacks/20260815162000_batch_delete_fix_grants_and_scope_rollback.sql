...
-- Rollback: restore previous function behavior and revoke the admin UPDATE grant
...
BEGIN
  ...
  -- student_batches deletion (corrected: table has no institute_id column, delete by batch_id only)
...
-- Revoke the UI grant added in forward migration
