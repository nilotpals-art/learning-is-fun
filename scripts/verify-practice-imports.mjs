...
try {
  await build({
    entryPoints: ["features/practice-work/services/document-extraction-service.test.ts", "features/practice-work/services/gemini-document-extraction-provider.test.ts", "features/practice-work/services/gemini-question-generation-provider.test.ts", "features/practice-work/services/practice-work-module-boundary.test.ts"],
    outdir: directory,
    entryNames: "[name]",
    bundle: true,
    format: "cjs",
  ...
  await import(pathToFileURL(join(directory,"practice-work-module-boundary.test.js")));
