...
interface AppHeaderProps { instituteName: string; navigationItems: readonly NavigationItem[]; user: { name: string; email: string | null; role: string }; parentTheme?: boolean; }
